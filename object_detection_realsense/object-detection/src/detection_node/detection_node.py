...
class ObjectDetector3D: 
    ...
    def init_publishers(self):
        ...
        # Publisher for 3d pose of detected objects
        self.detected_object_pose = rospy.Publisher(self.publishers['detected_objects_pose']['topic'], \
                PointStamped, queue_size=self.publishers['detected_objects_pose']['queue_size'])
    ...
    def publish_output(self):
        ...
        if (len(self.detected_objects) > 0):
            ...
            # publish the 3d position of detected object 
            self.detected_object_pose.publish(point_stamped)
